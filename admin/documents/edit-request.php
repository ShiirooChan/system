       <?php include('main_header/header.php');?>
        ...
        <!-- wrapper  -->
        <!-- ============================================================== -->
        <div class="dashboard-wrapper" style="background-color: rgb(255,240,179);">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="validationform" name="docu_forms" data-parsley-validate="" novalidate="" method="POST">
                                                ...
                                                <div class="form-group row">
                                                 ...
                                                 <div class="form-group row">
                                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">Appointment Date</label>
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                       <select data-parsley-type="alphanum" type="text" value="<?= $row['status']; ?>" id="status" required="" placeholder="" class="form-control">
                                                           ...
                                                           <option value="Scheduled" style="background-color: yellow;color: #fff">Scheduled</option>
                                                           <option value="Completed" style="background-color: green;color: #fff">Completed</option>
                                                        </select>
                                                    </div>
                                                </div>
