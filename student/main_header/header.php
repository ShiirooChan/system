...
<head>
    ...
    <title>Pateros Technological College Online Document Request</title>
    <style>
        ul.navbar-nav li a{
...
.navbar-brand{
    background-color: rgb(49,215,55);
}
.fixed-top{
    background-color: rgb(49,215,55);
}
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg fixed-top">
               <a class="navbar-brand" href="index.php"><p style="color: black;font-size: 100%;size: 3em">Pateros Technological College</p></a>
                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                         ...
                         <li class="nav-item dropdown">
                            <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="badge badge-danger count"></span>&nbsp;<i class="fa fa-bell"></i></a>
