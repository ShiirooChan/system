                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="validationform" name="docu_forms" data-parsley-validate="" novalidate="" method="POST">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                        <select name="document_name" data-parsley-type="alphanum" required="" class="form-control">
                                                            ...
                                                            <option value="Authentication of School Record">Authentication of School Record</option>
                                                            <option value="Change Registration Form">Change Registration Form</option>
