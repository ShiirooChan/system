    ...
    background: transparent;
        ...
        <!-- wrapper  -->
        <!-- ============================================================== -->
        <div class="dashboard-wrapper" style="background-color: rgb(232,228,201);">
                                    ...
                                    <div class="card influencer-profile-data">
                                        <div class="card-body">
                                         ...
                                         <div class="col-6 offset-3">
                                          <div class="form-box">
                                           <div class="form-text">
                                               Please go to Pateros Technological College site to process '<?= $row['document_name']; ?>
                                               ' on date '<?= date("M d, Y",strtotime($row['date_releasing'])); ?>'
